...
# #
# day_in_month = [28,30,31]
# name =[i for i in range(1,11)]
# max_time = 144
# work_time = 12
# start_work = [8, 10]
# end_work = [20,22]
# max_work = max_time//work_time
# def get_month_index(index): # функция выбора текущего месяца для которого требуется создать план смен
#     months = {
#         "January": 2,
#         "February": 0,
#         "March": 2,
...
# get_month_index(index)

# Ваша функция для получения индекса месяца
